...
const { createNote, getUserNotes, getSingleNote, updateNote, deleteNote, getNotesStats } = require('../controllers/notesController');
...
router.get('/stats', authenticateToken, getNotesStats); // Get Notes Statistics
